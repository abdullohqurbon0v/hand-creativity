     ...
     return (
          <div className=''>
               <div className='bg-slate-950 h-screen text-white flex flex-col justify-center items-center '>
                    <motion.h1 initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 1 }} className='font-monospace font-thin text-5xl'>Join to us telegram channel</motion.h1>
